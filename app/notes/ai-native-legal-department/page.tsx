...
export default function NoteOne() {
  return <main>
    <header className="site-header site-header-scrolled"><a className="brand" href="/"><span className="brand-mark">A</span><span>AGI Counsel Network</span></a><nav aria-label="Primary navigation"><a href="/">Home</a><a href="/notes/">All notes</a><a className="language-switch" href="/zh/notes/ai-native-legal-department/?lang=zh">中文</a><a className="nav-join" href="/#contribute">Contribute</a></nav></header>

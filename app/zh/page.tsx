...
export default function ChineseHome() {
  ...
  return <main lang="zh-CN">
    ...
    <section className="intro section fade-in" id="about">
      <div className="section-label">01 / 我们为何存在</div>
      <div className="intro-content"><p className="kicker">法律工作正在改变。</p><h2>人工智能不仅在重塑法律与商业，也在重新定义法律专业人士的角色。</h2>
        <div className="intro-columns"><p>许多最重要的问题并没有现成答案。它们跨越行业、技术、司法辖区与组织边界，不断涌现。</p><p>AGI Counsel Network 汇聚资深法律专业人士，交流实践、磨砺判断，并共同面对未来。</p></div>
      </div>
    </section>

    <section className="stack-section fade-in">
      <div className="section stack-heading"><div className="section-label">02 / 贯穿 AI 产业链</div><div><p className="kicker">同一生态，共同议题。</p><h2>连接人工智能每一层的法律专业人士。</h2></div></div>

...
export default function Home() {
  return <main>
    ...
    <section className="principles" id="principles"><div className="section principles-inner">
    ...
    <section className="join section" id="join"><div className="join-card"><p className="kicker kicker-light">An intentionally small network.</p><h2>Bring your judgment.<br />Leave with better questions.</h2><p>Membership is currently invitation-based. If our purpose resonates, we would be glad to hear from you.</p><a className="button button-light" href="mailto:hello@agicounsel.org?subject=AGI%20Counsel%20Network%20—%20Membership%20interest">Express interest <span>↗</span></a></div></section>
